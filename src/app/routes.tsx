...
import { ProtectedDoctorRoute, ProtectedPatientRoute } from "./components/mobile/ProtectedRoute";
...
export const router = createBrowserRouter([
  ...
  { path: "/tipo-usuario", Component: UserTypeSelection },
  { path: "/login-paciente", Component: LoginPatient },
  { path: "/login-doctor", Component: LoginDoctor },

  // Rutas protegidas — doctor
  {
    element: <ProtectedDoctorRoute />,
    children: [
      { path: "/doctor/home", Component: HomeDoctor },
      { path: "/doctor/pacientes", Component: PatientList },
      { path: "/doctor/registrar", Component: RegisterPatient },
      { path: "/doctor/ficha/:id", Component: PatientFile },
      { path: "/doctor/interpretacion", Component: ClinicalInterpretation },
      { path: "/doctor/tratamiento", Component: TreatmentGuide },
      { path: "/doctor/estadisticas", Component: Statistics },
    ],
  },

  // Rutas protegidas — paciente
  {
    element: <ProtectedPatientRoute />,
    children: [
      { path: "/paciente/home", Component: HomePatient },
      { path: "/paciente/perfil", Component: ProfilePatient },
      { path: "/paciente/riesgo", Component: RiskPatient },
      { path: "/paciente/riesgo-resultado", Component: RiskResult },
      { path: "/paciente/recordatorios", Component: RemindersPatient },
      { path: "/paciente/resultados", Component: ResultsPatient },
      { path: "/paciente/educacion", Component: EducationPatient },
    ],
  },
]);
